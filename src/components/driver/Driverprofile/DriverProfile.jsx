      ...
      <div className="">
        <div className=" car md:flex no-wrap h-screen  ">
          <div className=" w-full md:mx-2 md:mb-2">
            <div className=" car profileside bg-gray-200 h-screen p-5">
              ...
              <div className="flex justify-center details  drop-shadow-[6px_8px_6px_rgba(1,1,0,0.5)]">
                <ul className="w-full p-5 bg-white opacity-90 text-gray-600 hover:text-gray-700 hover:shadow  rounded shadow-sm md:w-1/3 md:p-10">
